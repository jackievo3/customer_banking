...
def main():
    ...
    # ADD YOUR CODE HERE
    savings_balance = float(input("Can you please provide your savings account balance? "))
    savings_interest = float(input("Please set your interest rate: "))
    savings_maturity = int(input("please provide the ammount of months of your account: "))
    ...
    print(f"For the ammount of months:{savings_maturity}")
